...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ImageDto uploadImage(@RequestParam("imageJson") String imageJson, @RequestParam("file") MultipartFile file) throws IOException {
        return imageService.uploadImage(imageJson, file);
    }
